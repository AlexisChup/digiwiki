...
class ToolFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $tool_4_1_1 = new Tool();
        $tool_4_1_1->setName("Backstop Solution");
        $tool_4_1_1->setUrl("backstop-solution");
        $tool_4_1_1->setShortDescription("Backstop Solution logiciel de gestion des investissements");
        $tool_4_1_1->setDescription("Le logiciel de gestion des investissements puissant et facile à utiliser. 
        ...
        $tool_4_1_1->setAffiliateRef("https://www.backstopsolutions.com/");
        $tool_4_1_1->setCodePromo("D");
        $tool_4_1_1->setImgUrl("https://www.backstopsolutions.com/hs-fs/hubfs/BackstopSolutions_Corp_Original_FullColor_RTM%20(1).png?width=450&height=113&name=BackstopSolutions_Corp_Original_FullColor_RTM%20(1).png");
        ...
        $this->addReference("tool_7_5_1", $tool_7_3_1);
        $this->addReference("tool_7_5_1", $tool_7_5_1);
        $this->addReference("tool_7_5_1", $tool_7_6_1);
