    ...
    <div className="container ">
      ...
      <div className="col-9 mx-auto col-9-resized-md">
        <div className="mt-3 mb-2">
          ...
          <p>
            La présente politique de confidentialité décrit nos politiques et procédures en matière de collecte, 
            d'utilisation et de divulgation de vos informations lorsque vous utilisez le service 
            et vous informe de vos droits en matière de confidentialité et de la manière dont la loi vous protège.
          </p>
          <h2 className="mt-1 mb-1">Definitions</h2>
          <ul>
            <li>
              <p>
                <strong>L'Éditeur</strong> correspond à la personne, physique ou morale, 
                qui édite les services de communication au public en ligne.
              </p>
            </li>
            <li>
              <p>
                <strong>Le Site</strong> réfère à l'ensemble des sites, 
                pages Internet et services en ligne proposés par l'Éditeur.
              </p>
            </li>
            <li>
              <p>
                <strong>L'Utilisateur</strong> est la personne utilisant le Site et les services proposés.
              </p>
            </li>
            <li>
              <p>
                <strong>Pays</strong> faisant référence à la France.
              </p>
            </li>
            <li>
              <p>
                <strong>Données personnelles</strong> toutes informations correpondant à un individu identifié ou non.
              </p>
            </li>
          </ul>
          <h2 className="mt-1 mb-1">Nature des données collectées</h2>
          <h4 className="mt-2 mb-2">Données personnelles</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Données d'utilisation</h4>
          <p>Les données d'utilisation sont collectées automatiquement lors de l'usage de nos Services.</p>
          <p>
            Les Données d'utilisation peuvent inclure des informations telles que l'adresse de protocole Internet 
            (par exemple, l'adresse IP) de votre Appareil, le type de navigateur, la version du navigateur, 
            les pages de notre Service que vous visitez, l'heure et la date de votre visite, le temps passé sur ces pages, 
            les identifiants uniques des appareils et d'autres données de diagnostic.
          </p>
          <h2 className="mt-1 mb-1">Communication des données personnelles à des tiers</h2>
          <h4 className="mt-2 mb-2">Pas de communication à des tiers</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Information préalable pour la communication des données personnelles à des tiers en cas de fusion / absorption</h2>
          <h4 className="mt-2 mb-2">Collecte de l’opt-in (consentement) préalable à la transmission des données suite à une fusion / acquisition</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Agrégation des données</h2>
          <h4 className="mt-2 mb-2">Agrégation avec des données non personnelles</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Agrégation avec des données personnelles disponibles sur les comptes sociaux de l'Utilisateur</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Collecte des données d'identité</h2>
          <h4 className="mt-2 mb-2">Utilisation d’une identité</h4>
          <p>
            L’utilisation du Site ne nécessite pas une inscription et identification préalable. L’utilisation du Site 
            peut s’effectuer sans que vous ne communiquiez de données nominatives vous concernant (nom, prénom,
            adresse email, etc). L'inscription pour accéder à d'autre fonctionnalités du site nécessite cependant
            certaines données nominatives.
          </p>
          <h2 className="mt-1 mb-1">Collecte des données d'identification</h2>
          <h4 className="mt-2 mb-2">Utilisation de l'identifiant de l’utilisateur uniquement pour l’accès aux services</h4>
          <p>
            Nous utilisons vos identifiants électroniques seulement pour et pendant l'exécution du contrat.
          </p>
          <h2 className="mt-1 mb-1">Collecte des données du terminal</h2>
          <h4 className="mt-2 mb-2">Collecte des données de profilage et des données techniques à des fins de fourniture du service</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Collecte des données techniques à des fins publicitaires, commerciales et statistiques</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Cookies</h2>
          <h4 className="mt-2 mb-2">Durée de conservation des cookies</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Finalité cookies</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Droit de l'Utilisateur de refuser les cookies</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Conservation des données techniques</h2>
          <h4 className="mt-2 mb-2">Durée de conservation des données techniques</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Délai de conservation des données personnelles et d'anonymisation</h2>
          <h4 className="mt-2 mb-2">Pas de conservation des données</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Suppression des données après suppression du compte</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Suppression des données après 3 ans d'inactivité</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Suppression du compte</h2>
          <h4 className="mt-2 mb-2">Suppression du compte à la demande</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Suppression du compte en cas de violation de la Politique de Confidentialité</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Indications en cas de faille de sécurité décelée par l'Éditeur</h2>
          <h4 className="mt-2 mb-2">Information de l'Utilisateur en cas de faille de sécurité</h4>
          <p>
          ...
          <h4 className="mt-2 mb-2">Limitation de la responsabilité</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Transfert des données personnelles à l'étranger</h2>
          <h4 className="mt-2 mb-2">Pas de transfert en dehors de l'Union européenne</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Modification de la politique de confidentialité</h2>
          <h4 className="mt-2 mb-2">Notification du changement de politique</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Droit applicable et modalités de recours</h2>
          <h4 className="mt-2 mb-2">Clause d'arbitrage</h4>
          <p>
          ...
          <h2 className="mt-1 mb-1">Portabilité des données</h2>
          <h4 className="mt-2 mb-2">Portabilité des données</h4>
          <p>
