        ...
        <div className="col-responsive">
          <div className="mt-3 mb-2">
            ...
            <p>
              ...
              procédures en matière de collecte, d'utilisation et de divulgation
            ...
            <ul>
              <li>
                <strong>L'Éditeur</strong> correspond à la personne, physique ou
                morale, qui édite les services de communication au public en
                ligne.
              </li>
              <li>
                <strong>Le Site</strong> réfère à l'ensemble des sites, pages
                Internet et services en ligne proposés par l'Éditeur.
              </li>
              <li>
                <strong>L'Utilisateur</strong> est la personne utilisant le Site
              ...
              <li>
                <strong>Données personnelles</strong> toutes informations
                correpondant à un individu identifié ou non.
              </li>
            </ul>
            ...
            <p>
              ...
              que l'adresse de protocole Internet (par exemple, l'adresse IP) de
              votre Appareil, le type de navigateur, la version du navigateur,
            ...
            <p>
              ...
              transmission de vos données personnelles et à maintenir le niveau
              de confidentialité de vos données personnelles auquel vous avez
              consenti.
            </p>
            ...
            <p>
              L’utilisation du Site ne nécessite pas une inscription et
              identification préalable. L’utilisation du Site peut s’effectuer
              sans que vous ne communiquiez de données nominatives vous
              concernant (nom, prénom, adresse email, etc). L'inscription pour
              accéder à d'autre fonctionnalités du site nécessite cependant
            ...
            <p>
              ...
              navigateur... La collecte de ces données est nécessaire à la
            ...
            <p>
              Nous ne conservons aucune donnée personnelle au delà de votre
              durée de connexion au service pour les finalités décrites dans les
              présentes Politique de confidentialité.
            </p>
            <h4 className="mt-2 mb-2">
            ...
            <p>
              ...
              confidentialité de vos données de manière substantielle sans vous
              en informer et obtenir votre consentement.
            </p>
            <h2 className="mt-1 mb-1">
